# 16-mask-safety-T4-debug

## 概要

15-mask-safety-T4 の debug_read 版。@collect を使わず、debug_read で GRF0 から r16/r18 を直接読み出す。

制約: emu:lib では debug_read(GRF0) が常に 0 を返す。emu:process または実機で使用すること。
