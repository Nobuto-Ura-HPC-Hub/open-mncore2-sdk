/* ex_mv_4a.c — MV パターン 4A: PDM@G0~3 → PDM@G0 gather (3x individual mvp, 3.5.8.8)
 *
 * 4 グループの PDM データを G0 に gather 後、PDM@G0 から受信。
...
int main(void)
{
    printf("[ex] MV 4A: PDM@G0~3→PDM@G0 gather (3x mvp, 3.5.8.8)\n");
    ...
    mnc2_kernel_t k = mnc2_load_kernel(dev, "_build/mv-p4a.idma.dat");
