/* ex_mv_2a.c — MV パターン 2A: PDM→DRAM scatter (4x individual mvp, 3.5.8.2)
 *
 * PDM@G0[0..63] を DRAM@G0~3 に個別コピー後、DRAM@G0~3 → PDM@G0 に gather。
...
int main(void)
{
    printf("[ex] MV 2A: PDM→DRAM scatter (4x mvp, 3.5.8.2)\n");
    ...
    mnc2_kernel_t k = mnc2_load_kernel(dev, "_build/mv-p2a.idma.dat");
