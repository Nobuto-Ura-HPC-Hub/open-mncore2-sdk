/* ex_mv_1a.c — MV パターン 1A: PDM→PDM scatter (3x individual mvp, 3.5.8.8)
 *
 * PDM@G0[0..63] を G1/G2/G3 にコピー後、全グループから recv。
...
int main(void)
{
    printf("[ex] MV 1A: PDM→PDM scatter (3x mvp, 3.5.8.8)\n");
    ...
    mnc2_kernel_t k = mnc2_load_kernel(dev, "_build/mv-p1a.idma.dat");
