/* ex_mv_10.c — MV パターン 10: DRAM→L2BM 個別並列 (3.5.8.11) roundtrip
 *
 * DRAM@G[0..3] → L2BM@G.0 に個別並列転送後、L2BM → PDM@G0~3 に戻す。
...
int main(void)
{
    printf("[ex] MV 10: DRAM→L2BM 個別並列 (3.5.8.11) roundtrip\n");
    ...
    mnc2_kernel_t k = mnc2_load_kernel(dev, "_build/mv-p10.idma.dat");
